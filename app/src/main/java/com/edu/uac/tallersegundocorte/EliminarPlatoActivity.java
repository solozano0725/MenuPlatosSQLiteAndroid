...
public class EliminarPlatoActivity extends AppCompatActivity {

    EditText edt_nombre;
    TextView cod, desc, tplato, tcomida, precio;
    Button btn_Buscar, btn_Eliminar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Eliminar= (Button) findViewById(R.id.boton_eliminar);
    ...
    public void Eliminar()
    {
        ...
        bd.eliminarPlato(codigo);

        Toast.makeText(this, "Se eliminó el plato!", Toast.LENGTH_SHORT).show();
    }
